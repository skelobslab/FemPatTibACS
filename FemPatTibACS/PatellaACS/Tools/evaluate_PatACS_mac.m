...
pTR = [pTR createInventorArrow(patTRg(1:3,4)',-patTRg(1:3,1)',40,0.5,[0.5 0.5 1],0)];
pTR = [pTR createInventorArrow(patTRg(1:3,4)',-patTRg(1:3,2)',40,0.5,[1 0.5 0.5],0)];
pTR = [pTR createInventorArrow(patTRg(1:3,4)',patTRg(1:3,3)',40,0.5,[0.5 1 0.5],0)];
pTR = [pTR createInventorSphere(patTRg(1:3,4)',2,[1 1 1],0)];

pTB = [pTB createInventorArrow(boxTg(1:3,4)',-boxTg(1:3,1)',40,0.5,[0.5 0.5 1],0)];
pTB = [pTB createInventorArrow(boxTg(1:3,4)',-boxTg(1:3,2)',40,0.5,[1 0.5 0.5],0)];
pTB = [pTB createInventorArrow(boxTg(1:3,4)',boxTg(1:3,3)',40,0.5,[0.5 1 0.5],0)];
...
pTR = [pTR createInventorArrow(patTRg(1:3,4)',-XrR,50,1.2,[0 0 1],0)];
pTR = [pTR createInventorArrow(patTRg(1:3,4)',-YrR,50,1.2,[1 0 0],0)];
pTR = [pTR createInventorArrow(patTRg(1:3,4)',ZrR,50,1.2,[0 1 0],0)];

pTB = [pTB createInventorArrow(boxTg(1:3,4)',-XrB,50,1.2,[0 0 1],0)];
pTB = [pTB createInventorArrow(boxTg(1:3,4)',-YrB,50,1.2,[1 0 0],0)];
pTB = [pTB createInventorArrow(boxTg(1:3,4)',ZrB,50,1.2,[0 1 0],0)];
pTB = [pTB createInventorSphere(boxTg(1:3,4)',2,[1 1 1],0)];
...
bar([mean(ang_outR); mean(ang_outB); mean(ang_outI)]')
